...
// マクロ定義
#define TEXTURE_ICON01					("data/TEXTURE/player01.png")	// P1アイコン画像
#define TEXTURE_ICON02					("data/TEXTURE/player02.png")	// P2アイコン画像
#define TEXTURE_ICON03					("data/TEXTURE/cpu_icon.png")	// CPUアイコン画像
